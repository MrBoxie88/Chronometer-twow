...
--                kind,       name,                  duration, targeted, isgain, selforselect, extra
	...
	self:AddTimer(self.SPELL, BS["Hammer of Justice"],       6, 1,0,0, { d={rt={3,4,5,6}} })
	-- self:AddTimer(self.SPELL, BS["Holy Might"],         	20, 0,1,1, { })
	self:AddTimer(self.SPELL, BS["Holy Shield"],            10, 1,0,0)
	self:AddTimer(self.SPELL, BS["Holy Strike"],             0, 1,0,0, { d={tn=BS["Vengeful Strikes"]}, ea={[BS["Holy Might"]]=20} })
	...
	self:AddTimer(self.EVENT, BS["Holy Might"],           	   20, 0,1,1, { cr="GREEN", xn=BS["Holy Strike"], a=1, rc=true })
